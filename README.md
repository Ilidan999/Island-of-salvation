...
| № | Тема работы | Статус | Вариация | Исходный код |
| :--- | :--- | :---: | :--- | :--- |
| **01** | Теория вероятности и математическая статистика. Повторение | ✅ | ✅ | [Открыть файл](./Лабораторные/ЛР1.ipnb) |
| **02** | Статистика Выбросы. Доверительный интервал | 📅 | 📅 | *В процессе* |
| **03** |  📅 | 📅 | 📅 | *В планах* |
